...
window.StickerTour = (() => {
  ...
  const STEPS = [
    ...
    { id: 'shaker-liquid', chapter: 'Decorate', title: 'Liquid & glitter', shaker: true, tab: 'propertiesTab', menu: 'iconMenuWrap', details: '#shakerLiquidSection', targets: ['#shakerLiquidSection', '#btnShaker'],
      text: 'Turn on Liquid filling for a sloshing charm with floating glitter and bubbles.',
      points: ['Choose the liquid colour, fill level, thickness, and amount of glitter.', 'Shake to swirl the glitter, then watch it settle.', 'Water to syrup · thicker liquid slows the pieces.'] },
    { id: 'shaker-magnet', chapter: 'Decorate', title: 'Magnet play', shaker: true, tab: 'propertiesTab', menu: 'iconMenuWrap', details: '#shakerMagnetSection', targets: ['#shakerMagnetSection', '#btnShaker'],
      text: 'Choose Attract or Repel, then drag inside the glass. Drag the rim to move the shaker.',
      points: ['Adjust Magnet strength, or use Preview magnet for a hands-free sweep.', 'Liquid and magnet play can be used together. Release or press Escape to let go.', 'Animated exports include a circular magnet sweep.'] },
    ...
    { id: 'animation', chapter: 'Bring it to life', title: 'Let your stickers move', group: 'motion', targets: ['.control:has(#ctl-anim)'], preview: 'motion',
      ...
      points: ['Speed changes the pace; Amount changes how much it moves.', 'Surface animation adds foil reveals, peeling corners, glass ripples, lenticular flips, or a staggered sticker assembly. Choose a trigger and preview it.', 'Lenticular flip uses a second image. Choose Follow pointer to change pictures by moving across the sticker, or tap on a touch screen.', 'Assembly brings in the frame, its photo, and attached icons in order. Select the parent to preview the whole group.', 'Hover tilt, grab lift, spring, and damping change how it feels to drag.', 'GIF, animated PNG, and animated SVG include surface effects. Interactive effects become one complete cycle per export loop.'] },
    { id: 'motion-designer', chapter: 'Bring it to life', title: 'Direct your own little animation', group: 'motion', targets: ['#motionEntry'], preview: 'motion',
      text: 'Select a sticker or frame, then open Design motion in Motion. Start with a recipe and make it your own.',
      points: ['Choose Start pose or End pose to move, resize, turn, fade, or tilt the group. Attached icons come along.', 'Set the duration, holds, easing, and a light path. Loop returns to Start; Play once stays at End.', 'Use the canvas timeline to play or scrub. Apply motion saves your changes; Cancel keeps the previous motion.', 'Designed motion is included in GIF, animated PNG, animated SVG, and recorded clips. Use original motion restores your previous animation settings.'] },
