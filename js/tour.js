...
window.StickerTour = (() => {
  ...
  const STEPS = [
    ...
    { id: 'scene', chapter: 'Organize & reuse', title: 'Set the scene', group: 'scene', targets: ['[data-group="scene"]'],
      ...
      points: ['The transparency grid helps you inspect transparent areas.', 'Canvas PNG and the recorded clip include the backdrop.', 'Sticker PNG exports keep a transparent background.'] },
